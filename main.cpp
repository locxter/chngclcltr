...
int main(int argc, char** argv) {
    ...
    calculateButton.signal_clicked().connect([&]() {
        ...
        if (change >= 0) {
            ...
            numberOf200EuroNotesData.set_label(std::to_string(change / 20000));
            change -= (change / 20000) * 20000;
            numberOf100EuroNotesData.set_label(std::to_string(change / 10000));
            change -= (change / 10000) * 10000;
            numberOf50EuroNotesData.set_label(std::to_string(change / 5000));
            change -= (change / 5000) * 5000;
            numberOf20EuroNotesData.set_label(std::to_string(change / 2000));
            change -= (change / 2000) * 2000;
            numberOf10EuroNotesData.set_label(std::to_string(change / 1000));
            change -= (change / 1000) * 1000;
            numberOf5EuroNotesData.set_label(std::to_string(change / 500));
            change -= (change / 500) * 500;
            numberOf2EuroCoinsData.set_label(std::to_string(change / 200));
            change -= (change / 200) * 200;
            numberOf1EuroCoinsData.set_label(std::to_string(change / 100));
            change -= (change / 100) * 100;
            numberOf50CentCoinsData.set_label(std::to_string(change / 50));
            change -= (change / 50) * 50;
            numberOf20CentCoinsData.set_label(std::to_string(change / 20));
            change -= (change / 20) * 20;
            numberOf10CentCoinsData.set_label(std::to_string(change / 10));
            change -= (change / 10) * 10;
            numberOf5CentCoinsData.set_label(std::to_string(change / 5));
            change -= (change / 5) * 5;
            numberOf2CentCoinsData.set_label(std::to_string(change / 2));
            change -= (change / 2) * 2;
            ...
            numberOf100EuroNotesData.set_label("");
            numberOf50EuroNotesData.set_label("");
            numberOf20EuroNotesData.set_label("");
            numberOf10EuroNotesData.set_label("");
            numberOf5EuroNotesData.set_label("");
            numberOf2EuroCoinsData.set_label("");
            numberOf1EuroCoinsData.set_label("");
            numberOf50CentCoinsData.set_label("");
            numberOf20CentCoinsData.set_label("");
            numberOf10CentCoinsData.set_label("");
            numberOf5CentCoinsData.set_label("");
            numberOf2CentCoinsData.set_label("");
            numberOf1CentCoinsData.set_label("");
        }
    });
